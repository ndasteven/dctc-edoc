...
//             case 'E':
//                 // Afficher uniquement le bouton "Ouvrir"
//                 $this->showMessageButton = true;
//                 $this->showOpenButton = true;
//                 $this->showEditButton = false;
//                 break;
...
//             case 'L':
//                 // Afficher uniquement le bouton "Laisser un message"
//                 $this->showMessageButton = true;
//                 $this->showOpenButton = false;
//                 $this->showEditButton = false;
//                 break;
...
//             default:
//                 // Aucune permission - masquer tous les boutons
//                 $this->showMessageButton = false;
//                 $this->showOpenButton = false;
//                 $this->showEditButton = false;
//                 break;
...
//     public function ouvrirHorsApplication()
//     {
//         // Logique pour ouvrir hors de l'application
//         // Par exemple, forcer le téléchargement du fichier
//         return response()->download(storage_path('app/documents/' . $this->document->filename));
//     }
