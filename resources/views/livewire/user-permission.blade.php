            ...
            <div class="flex justify-between">
                <div class="relative flex-grow mr-4">
                    <label for="small-input"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rechercher
                        un
                        utilisateur</label>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full  text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="usersPermissionsList" class="divide-y divide-gray-200 bg-white">
                    <!-- Bouton pour attribuer les permissions à tous les utilisateurs du service -->
                    <tr>
                        <td>Appliquer à tous les utilisateurs du service</td>
                        <td class="px-4 py-2 text-right">
                            <div class="flex space-x-2">
                                <button wire:click="assignPermissionsToService('L')"
                                    class="px-2 py-1 text-xs bg-yellow-500 hover:bg-yellow-600 text-white rounded">Lecture</button>
                                <button wire:click="assignPermissionsToService('E')"
                                    class="px-2 py-1 text-xs bg-red-700 hover:bg-red-600 text-white rounded">Écriture</button>
                                <button wire:click="assignPermissionsToService('LE')"
                                    class="px-2 py-1 text-xs bg-green-500 hover:bg-green-600 text-white rounded">L/E</button>
                                <span wire:loading wire:target="assignPermissionsToService" role="status">
                                    <svg aria-hidden="true"
                                        class="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                                        viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
