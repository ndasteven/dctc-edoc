                                ...
                                <td class="px-4 py-2 text-right">
                                    ...
                                    <form method="POST" action="{{ route('permissions.store') }}">
                                        ...
                                        @if (isset($infoPropriete) && $infoPropriete instanceof \App\Models\Folder)
                                            <input type="hidden" name="folder_id" value="{{ $infoPropriete->id }}">
                                            <input type="hidden" name="folder" value="{{ $infoPropriete->name }}">

                                            <!-- Si on est sur un document -->
                                        @elseif(isset($infoPropriete) && $infoPropriete instanceof \App\Models\Document)
                                            <input type="hidden" name="document_id" value="{{ $infoPropriete->id }}">
                                            <input type="hidden" name="document" value="{{ $infoPropriete->name }}">
                                        @endif
