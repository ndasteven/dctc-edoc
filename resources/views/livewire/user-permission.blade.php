<div id="permissionModal" wire:ignore.self
    ...
    <div 
        ...
        x-transition
        x-init="
            window.addEventListener('permissionSave', () => {
                show = true;
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-3xl  max-h-[85vh] overflow-y-auto">
        ...
        <div class="grid grid-cols md:grid-cols-2">
            ...
            <div class="relative">
                ...
                <div wire:loading wire:target="searchUser" role="status" style="position: absolute; bottom:15px; right:5px;">
                                ...
                                <td class="px-4 py-2 text-right">
                                    ...
                                    <form method="POST" wire:submit.prevent='savePermission({{ $user->id }})'>
                                        ...
                                        <div class="inline-flex items-center space-x-4 mr-4">
                                            ...
                                            <label class="inline-flex items-center">
                                                <input id="inline-radio-{{ $user->id }}" type="radio"  wire:model="permission" value="L"
                                                    class="form-radio h-4 w-4 text-blue-600" checked>
                                                <span class="ml-2">Lecture</span>
                                            </label>

                                            <label class="inline-flex items-center">
                                                <input id="inline-radio-{{ $user->id }}" type="radio"  wire:model="permission" value="E"
                                                    class="form-radio h-4 w-4 text-blue-600">
                                                <span class="ml-2">Écriture</span>
                                            </label>
                                            <label class="inline-flex items-center">
                                                <input id="inline-radio-{{ $user->id }}" type="radio"  wire:model="permission" value="LE"
                                                    class="form-radio h-4 w-4 text-blue-600">
                                                <span class="ml-2">Lecture/Écriture</span>
                                            </label>
                                        </div>
