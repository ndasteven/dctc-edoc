<div class="mx-auto">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8 relative">
        ...
        {{-- vue pour le classeur lorsquon entre dans un service cesr la vue qui affiche les dossier liee a ce service --}}
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-white relative overflow-auto"
                ...
                @foreach ($folders as $index => $folder)
                    <div wire:key={{ $index }}
                        ...
                        <!-- Dropdown menu pour les dossiers -->
                        <div id="dropdownRight-{{ $folder->id }}"
                            ...
                            <ul class=" text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRightButton">
                                ...
                                <small>
                                    <li style="border-top: solid 1px white">
                                        <button
                                            href="#"class="block px-4 text-white  py-1 hover:bg-gray-600 hover:text-white  dark:hover:bg-gray-600 dark:hover:text-white inline-flex flex justify-between items-center w-full "@click="clickModalPropriete"wire:click="
                                            getIds({{ $folder->id }},'folder')"><span>propriété</span><span></span>
                                            <svg class="w-4 h-4 text-white dark:text-white" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="none" viewBox="0 0 24 24">
                                                <path stroke="currentColor"
                                                    stroke-linecap="round"stroke-linejoin="round"
                                                    stroke-width="2"d="M18 9V4a1 1 0 0 0-1-1H8.914a1 1 0 0 0-.707.293L4.293 7.207A1 1 0 0 0 4 7.914V20a1 1 0 0 0 1 1h4M9 3v4a1 1 0 0 1-1 1H4m11 6v4m-2-2h4m3 0a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z" />
                                            </svg>
                                        </button>
                                    </li>
                                </small>
    ...
    <!-- Main modal pour ajoutee un fichier dans un dossier -->
